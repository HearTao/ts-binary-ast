...
export default class Emitter {
  ...
  emitAssertedMaybePositionalParameterNameList(
    nodes: FrozenArray<AssertedMaybePositionalParameterName>
  ) {
    this.emitList(
      nodes,
      this.emitAssertedMaybePositionalParameterName.bind(this)
    )
  }

  emitAssertedMaybePositionalParameterName(
    node: AssertedMaybePositionalParameterName
  ) {
    switch (node.type) {
  ...
  emitForStatement(node: ForStatement) {
    ...
    this.emitOptional(
      node.init,
      this.emitVariableDeclarationOrExpression.bind(this)
    )
  ...
  emitForInOfBindingOrAssignmentTarget(
  ...
  emitAssignmentTargetPropertyList(
    nodes: FrozenArray<AssignmentTargetProperty>
  ) {
  ...
  emitAssignmentTargetPropertyIdentifier(
  ...
  emitAssignmentTargetOrAssignmentTargetWithInitializerList(
    nodes: FrozenArray<AssignmentTarget | AssignmentTargetWithInitializer>
  ) {
    this.emitList(
      nodes,
      this.emitAssignmentTargetOrAssignmentTargetWithInitializer.bind(this)
    )
  }

  emitAssignmentTargetOrAssignmentTargetWithInitializer(
  ...
  emitArrayAssignmentTarget(node: ArrayAssignmentTarget) {
    this.emitType(node.type)
    this.emitAssignmentTargetOrAssignmentTargetWithInitializerList(
      node.elements
    )
  ...
  emitBindingOrBindingWithInitializerList(
  ...
  emitSpreadElementOrExpressionList(
  ...
  emitEagerArrowExpressionWithFunctionBody(
  ...
  emitLazyArrowExpressionWithFunctionBody(
  ...
  emitArrowExpressionContentsWithFunctionBody(
  ...
  emitEagerArrowExpressionWithExpression(
  ...
  emitLazyArrowExpressionWithExpression(
  ...
  emitArrowExpressionContentsWithExpression(
  ...
  emitExpressionOrTemplateElementList(
    nodes: FrozenArray<Expression | TemplateElement>
  ) {
